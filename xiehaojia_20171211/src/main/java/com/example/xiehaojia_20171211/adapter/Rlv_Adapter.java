package com.example.xiehaojia_20171211.adapter;
...
import com.example.xiehaojia_20171211.R;
import com.example.xiehaojia_20171211.bean.CartBean;
import com.example.xiehaojia_20171211.eventbusevent.MessageEvent;
import com.example.xiehaojia_20171211.eventbusevent.PriceAndCountEvent;
...
public class Rlv_Adapter extends RecyclerView.Adapter<Rlv_Adapter.MyViewHodler> {
    ...
    public void onBindViewHolder(final MyViewHodler holder, final int position) {
        ...
        Picasso.with(context).load(split[0]).resize(100, 100).into(holder.mShopIvCart);
